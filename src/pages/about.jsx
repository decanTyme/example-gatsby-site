  ...
  return (
    <AppShell>
      ...
      <p>
        ...
        between. However you build your website – build it fast, secure, and
        scalable with Gatsby 4.
      </p>
      ...
      <p>
        ...
        websites and apps. Owing to the fast performance of the sites it powers,
        impressive out-of-the-box features like code splitting, and friendly
        developer experience, Gatsby is fast becoming a staple of modern web
        development.
      </p>
    </AppShell>
  )
...
// `=` means default value in case no prop is provided
const GatsbyLogo = ({ h = 256, w = 256 }) => (
  <svg
